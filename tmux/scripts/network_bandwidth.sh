...
interface_get() {
  name="$(tmux show-option -gqv "@monokai-network-bandwidth")"
...
main() {
  ...
  network_name=""
  show_interface="$(tmux show-option -gqv "@monokai-network-bandwidth-show-interface")"
  interval_update="$(tmux show-option -gqv "@monokai-network-bandwidth-interval")"
